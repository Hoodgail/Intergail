export declare var Vector2Indexes: 0 | 1
...
export default class Vector2 {
    ...
    setComponent(index: typeof Vector2Indexes, value: number) {
    ...
    getComponent(index: typeof Vector2Indexes): number {
    ...
    add(v: Vector2, w?: Vector2 | undefined) {
